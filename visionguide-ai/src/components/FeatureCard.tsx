...
export const FeatureCard = ({ title, description, icon: Icon, to, color = "#00FF00" }: FeatureCardProps) => {
  return (
    <motion.div
      ...
      className="group relative p-8 bg-[#151619] rounded-3xl border border-white/5 overflow-hidden transition-all hover:border-white/20"
    >
      {/* Background Glow */}
      <div 
      ...
      <div className="relative z-10 space-y-6">
        ...
        <Link 
          to={to}
          className="inline-flex items-center gap-2 text-[10px] font-mono font-bold uppercase tracking-widest text-white group-hover:text-[#00FF00] transition-colors"
        >
          Launch Module
